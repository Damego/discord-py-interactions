...
class CommandData:
    ...
    :ivar default_member_permissions: Indicates whether users should have permissions to run this command by default.
...
class BaseCommandObject(CommandObject):
    ...
    :ivar default_member_permissions: Indicates whether users should have permissions to run this command by default.
    :ivar dm_permission: Allows use slash command in dm.
    ...
    def __init__(self, name, cmd, _type=1):  # Let's reuse old command formatting.
        ...
        self.default_member_permissions = cmd["default_member_permissions"]
        self.dm_permission = cmd["dm_permission"]
